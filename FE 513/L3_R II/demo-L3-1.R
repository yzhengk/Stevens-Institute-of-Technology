...
setwd("c:/users/xingjia zhang/desktop")
goog = read.csv(file = "c:/users/xingjia zhang/desktop/GOOG.csv", head = T)
...
lines(c ~a  , col = rgb(255/255,102/255,102/255,255/255), lwd=3 , type="l" )
...
# 1. ggplot(data=df, mapping=aes(x, y, <other aesthetics>)) The method is recommended if all layers use the same data and the same set of 
